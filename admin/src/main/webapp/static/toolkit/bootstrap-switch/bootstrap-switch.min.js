    ...
    BootstrapSwitch = (function() {
      function BootstrapSwitch(element, options) {
        ...
        this.options = $.extend({}, $.fn.bootstrapSwitch.defaults, {
          ...
          //bycj[ 增加一个隐藏的input ]
          inputName:this.$element.data("input-name"),
          inputTrue:this.$element.data("input-true"),
          inputFalse:this.$element.data("input-false")
        }, options);
        this.prevOptions = {};
        ...
        //bycj[ 隐藏input 的元素]
        this.$myinput = this.options.inputName ? ($("<input>",{
          name:this.options.inputName,
          "type":"hidden",
          "value":this.$element.is(":checked")
              ?this.options.inputTrue
              :this.options.inputFalse
        })) :'';
        ...
        //
        this.$element.after(this.$myinput)
        ...
        return this.$element.on({
          ...
          "change.bootstrapSwitch": (function(_this) {
            return function(e, skip) {
              ...
              //bycj[  ]
              _this.$myinput != '' && (_this.$myinput.val(state
                  ? _this.options.inputTrue
                      :_this.options.inputFalse
              ));
