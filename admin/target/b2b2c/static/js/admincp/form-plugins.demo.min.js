...
var FormPlugins = function() {
	...
	return {
		init: function() {
			...
			handleDatepicker:handleDatepicker,
			handleFormMaskedInput:handleFormMaskedInput,
			handleFormColorPicker:handleFormColorPicker,
			handleFormTimePicker:handleFormTimePicker,
			handleFormPasswordIndicator:handleFormPasswordIndicator,
			handleJqueryAutocomplete:handleJqueryAutocomplete,
			handleBootstrapCombobox:handleBootstrapCombobox,
			handleSelectpicker:handleSelectpicker,
			handleTagsInput:handleTagsInput,
			handleJqueryTagIt:handleJqueryTagIt
