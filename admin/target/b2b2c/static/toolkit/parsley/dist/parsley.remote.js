...
window.ParsleyConfig = {
  validators: {
    ...
    membernameformat: {
      fn: function (value, requirements) {
        return (/^[A-Za-z0-9\u4e00-\u9fa5_-]{6,20}$/i.test(value) && !/^\d+$/.test(value));
      },
      priority: 50
    }
  }
...
window.ParsleyConfig.i18n.en = jQuery.extend(window.ParsleyConfig.i18n.en || {}, {
  ...
  notblank:       "请输入值,内容不能为空",
  required:       "必填选项,内容不能为空",
  pattern:        "您输入的格式不正确",
  min:            "输入值请大于或等于 %s",
  max:            "输入值请小于或等于 %s",
  ...
  length:         "输入的内容长度应该控制在 %s 到 %s 字符之间",
  mincheck:       "请至少选择 %s 个选项",
  maxcheck:       "请选择不超过 %s 个选项",
  check:          "请选择 %s 到 %s 个选项",
  equalto:        "两次输入值不同,请检查并重新输入",
  phonerequired:  "您输入的手机号码非标准格式,请检查并重新输入",
  membernameformat:  "请使用6-20个中、英文、数字及“-”符号，且不能全为数字"
});
