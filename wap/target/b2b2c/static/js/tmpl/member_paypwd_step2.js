...
//            	setTimeout("location.href = WapSiteUrl+'/tmpl/members/members_paypwd_step1.html'",2000);
//            }
//        }
//    });
    ...
    $('#nextform').click(function(){
        ...
        if($.sValid()){
            ...
            $.ajax({
                type:'post',
                url:WapSiteUrl+"/security/paypwd",
                data:{payPwd:password,repeatPayPwd:password1},
                dataType:'json',
                success:function(result){
                    if(result.code == 200){
                        $.sDialog({
