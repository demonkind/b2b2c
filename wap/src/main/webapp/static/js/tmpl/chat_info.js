...
$(function(){
    $.getJSON( ApiUrl+'/index.php?act=member_chat&op=get_node_info',{key:key,u_id:t_id,chat_goods_id:chat_goods_id}, function(result){
        ...
        if (!$.isEmptyObject(result.datas.chat_goods)) {
            ...
            var html = '<div class="nctouch-chat-product"> <a href="' + WapSiteUrl + '/tmpl/product_detail?goods_id=' + goods.goods_id + '" target="_blank"><div class="goods-pic"><img src="' + goods.pic36 + '" alt=""/></div><div class="goods-info"><div class="goods-name">' + goods.goods_name + '</div><div class="goods-price">￥' + goods.goods_promotion_price + '</div></div></a> </div>';
