...
$(function(){
    ...
    if(!key){
        window.location.href = WapSiteUrl+'/members/index';
    }
    ...
    // TODO comment by yfb 微信支付暂时不做，先注释掉
//    var readytopayWx = false;
	...
	function initPage(){
	 ...
	 // TODO comment by yfb 微信支付暂时不做，先注释掉   start =================================================
//    $.ajax({
//        type:'get',
...
//    });
    readytopay = true;
    // TODO comment by yfb 微信支付暂时不做，先注释掉   end =================================================
    ...
    $('#order-list').on('click','.evaluation-order', function(){
        ...
        location.href = WapSiteUrl + '/tmpl/members/members_vr_evaluation.html?order_id=' + orderId;
    });
