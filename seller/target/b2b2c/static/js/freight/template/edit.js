/**
 * Created by shopnc on 2016/1/21.
 */
toIntValue = function(value) {
    var s = parseInt(value.replace( /^0*/,''));
    return isNaN(s) ? 0 : s;
};
$(function(){
    ...
    TransTpl += "<\/div>\n";
    TransTpl += "<div class=\"batch p-5\" style=\"background-color: #F5F5F5; border-bottom: solid 1px #E6E6E6; display:none\">\n";
    TransTpl += "<label class=\"m-l-5 vm\"><input class=\"J_BatchCheck checkbox\" type=\"checkbox\" value=\"\" name=\"\">\n";
    TransTpl += "全选<\/label>\n";
    TransTpl += "&nbsp;<a class=\"J_BatchSet btn btn-xs btn-default vm\" href=\"JavaScript:void(0);\"><i class=\"icon icon-edit\"></i>批量设置<\/a>\n";
    TransTpl += "<a class=\"J_BatchDel btn btn-xs btn-default vm\" href=\"JavaScript:void(0);\"><i class=\"icon icon-trash\"></i>批量删除<\/a>\n";
    TransTpl += "<\/div>\n";
    TransTpl += "<div class=\"tbl-attach p-5\">\n";
    TransTpl += "<div class=\"J_SpecialMessage\"><\/div>\n";
    TransTpl += "<a class=\"J_AddRule btn btn-sm btn-white m-l-5\" href=\"JavaScript:void(0);\">";
    TransTpl += "<i class=\"icon icon-map-marker\"></i>为指定地区城市设置运费<\/a>\n";
    TransTpl += "<a class=\"J_ToggleBatch btn btn-sm btn-white\" style=\"display:none\" href=\"JavaScript:void(0);\">\n";
    TransTpl += "<i class=\"icon icon-check\"></i>批量操作<\/a>\n";
    TransTpl += "<\/div>\n";
    TransTpl += "<\/div>\n";
    TransTpl += "<\/div>\n";
    ...
    SpecialMessage += "<span  error_type=\"start\" class=\"msg J_Message\" style=\"display:none\"><i class=\"icon-exclamation-sign\"><\/i>首CALCNAME应输入1至9999的数字<\/span>\n";
    ...
    SpecialMessage += "<span error_type=\"plus\" class=\"msg J_Message\" style=\"display:none\"><i class=\"icon-exclamation-sign\"><\/i>续CALCNAME应输入1至9999的数字<\/span>\n";
    ...
    DefaultMessage = '';
    DefaultMessage += "<span error_type=\"start\" class=\"msg J_Message\" style=\"display:none\"><i class=\"icon-exclamation-sign\"><\/i>首CALCNAME应输入1至9999的数字<\/span>\n";
    ...
    DefaultMessage += "<span error_type=\"plus\" class=\"msg J_Message\" style=\"display:none\"><i class=\"icon-exclamation-sign\"><\/i>续CALCNAME应输入1至9999的数字<\/span>\n";
    ...
    //头模板
    RuleHead += "<table cellspacing=\"0\" class=\"ncsc-default-table\">\n";
    RuleHead += "<colgroup>\n";
	...
	RuleHead += "<th class=\"w10\"><\/th>\n";
    RuleHead += "<th class=\"tl\">运送到<\/th>\n";
	RuleHead += "<th class=\"w10\"><\/th>\n";
    RuleHead += "<th class=\"w50\">首CALCFULL<\/th>\n";
    RuleHead += "<th class=\"w110\">首费(元)<\/th>\n";
    RuleHead += "<th class=\"w50\">续CALCFULL<\/th>\n";
    RuleHead += "<th class=\"w110\">续费(元)<\/th>\n";
    RuleHead += "<th class=\"w150\">操作<\/th>\n";
    RuleHead += "<\/tr>\n";
    RuleHead += "<\/thead>\n";
    RuleHead += "<tbody>\n";
    RuleHead += "<\/tbody>\n";
	...
	RuleCell += "<td><\/td>\n";
    RuleCell += "<td class=\"tl cell-area\">\n";
//	RuleCell += "<a class=\"ncu-btn2\" title=\"编辑运送区域\" area-haspopup=\"true\" area-controls=\"J_DialogArea\" entype=\'J_EditArea\' data-acc=\"event:enter\" href=\"JavaScript:void(0);\">编辑<\/a>\n";
    ...
    RuleCell += "<input class=\"J_BatchField checkbox\" style=\"display:none\" type=\"checkbox\" value=\"\" name=\"TRANSTYPE_nCurNum\">\n";
    RuleCell += "<p style=\"display:inline-block\">未添加地区<\/p><\/span>\n";
    RuleCell += "<input type=\"hidden\" value=\"\" cindex=\"CurNum\" name=\"areas\">\n";
    RuleCell += "<\/td>\n";
	RuleCell += "<td><\/td>\n";
    RuleCell += "<td>\n";
    RuleCell += "<input class=\"text w40\" type=\"text\" maxlength=\"8\" autocomplete=\"off\" value=\"1\" data-field=\"start\" sindex=\"CurNum\" name=\"item1\">\n";
    RuleCell += "<\/td>\n";
    RuleCell += "<td>\n";
    RuleCell += "<input class=\"text w60\" type=\"text\" maxlength=\"6\" autocomplete=\"off\" value=\"\" sindex=\"CurNum\" data-field=\"postage\" name=\"price1\"><em class=\"add-on\">\n";
    RuleCell += "<i class=\"icon-renminbi\"><\/i>\n";
    RuleCell += "<\/em>\n";
    RuleCell += "<\/td>\n";
    RuleCell += "<td>\n";
    RuleCell += "<input class=\"text w40\" type=\"text\" maxlength=\"8\" autocomplete=\"off\" value=\"1\" sindex=\"CurNum\" data-field=\"plus\" name=\"item2\">\n";
    RuleCell += "<\/td>\n";
    RuleCell += "<td>\n";
    RuleCell += "<input class=\"text w60\" type=\"text\" maxlength=\"6\" autocomplete=\"off\" value=\"\" sindex=\"CurNum\" data-field=\"postageplus\" name=\"price2\"><em class=\"add-on\">\n";
    RuleCell += "<i class=\"icon-renminbi\"><\/i>\n";
    RuleCell += "<\/em>\n";
    RuleCell += "<\/td>\n";
    RuleCell += "<td class=\"nscs-table-handle\">\n";
	RuleCell += "<a class=\"btn btn-sm btn-primary m-r-5\" data-group=\"nCurNum\" title=\"编辑运送区域\" area-haspopup=\"true\" area-controls=\"J_DialogArea\" entype=\'J_EditArea\' data-acc=\"event:enter\" href=\"JavaScript:void(0);\">\n";
    RuleCell += "<i class=\"icon icon-edit\"><\/i>编辑\n";
    RuleCell += "<\/a>\n";
	RuleCell += "<a class=\"btn btn-sm btn-danger J_DeleteRule\" ncNum=\"nCurNum\" href=\"JavaScript:void(0);\">\n";
    RuleCell += "<i class=\"icon icon-trash\"><\/i>删除\n";
    RuleCell += "<\/a>\n";
    RuleCell += "<\/td>\n";
    RuleCell += "<\/tr>\n";
    ...
    $('.trans-line').on('click','.J_AddRule',function(){
        ...
        if ($(this).parent().parent().find('input[type="checkbox"]').css('display') == 'none'){
            $(this).next().css('display','').html('<i class="icon icon-check"></i>批量操作');
        }else{
            $(this).next().css('display','').html('<i class="icon icon-check-empty"></i>取消批量');
...
//		SelectArea = new Array();
        ...
        $('#J_CityList').find('.ncsc-province-tab').each(function(){
            ...
            //市被全选的情况
            if (a == b){
                CityText += ($(this).find('.J_Province').next().html())+'_';
            }else{
                //市被部分选中的情况
                $(this).find('.J_City').each(function(){
                    //计算并准备传输选择的区域值（具体到市级ID），以，隔开
                    if ($(this).attr('checked')){
                        CityText2 += ($(this).next().html())+'_';
                    }
                });
            }
        });
        ...
        $('#J_CityList').find('.ncsc-province-list').find('input[type="checkbox"]').each(function(){
            if ($(this).attr('checked')){
                CityValue += $(this).val()+'_';
            }
        });

        //去掉尾部的逗号
        CityText = CityText.replace(/(_*$)/g,'');
        CityValue = CityValue.replace(/(_*$)/g,'');

        //返回选择的文本内容
        if (CityText == '')CityText = '未添加地区';
        $(objCurlArea).find('.area-group>p').html(CityText);
        //返回选择的值到隐藏域
        $("input[cindex='"+curIndex.substring(1)+"']").val(CityValue+'|||'+CityText);
        //关闭弹出层与遮罩层
        $("#dialog_areas").css('display','none');
        $('.ks-ext-mask').css('display','none');
        //清空check_num显示的数量
...
//		curTransType = $(this).next().next().attr('name').substring(6,8);
        ...
        var expAreas = $("input[cindex='"+curIndex.substring(1)+"']").val();
        expAreas = expAreas.split('|||');
        expAreas = expAreas[0].split('_');
        ...
        $(objCurlArea).parent().parent().find('.area-group').each(function(){
            if ($(this).next().attr('cindex') != curIndex.substring(1)){
    ...
    $('.trans-line').on('blur','input[data-field="plus"]',function (){
        if ($(this).val() != ''){
            if (freightGlobal.calcType == "number") {
                $(this).val($(this).toInt());
            } else {
                $(this).val(Nc.numberFormat($(this).val(),2));
            }
    ...
    $('.trans-line').on('click','.J_DeleteRule',function (){
        ...
        Nc.layerConfirm('确认删除吗?',{}, function(){
...
//        	obj_parent = $(this).parent().parent().parent();
    ...
    $('.trans-line').on('click','.J_ToggleBatch',function(){
        if ($(this).parent().parent().find('.J_BatchField').eq(0).css('display')=='none'){
            ...
            $(this).html('<i class=\"icon icon-check\"></i>批量操作');
        }
    });
    ...
    $('.trans-line').on('click','.J_BatchSet',function(){
        if($('.tbl-except').find('input:checked').size()==0){
            Nc.alertError('请选择要批量设置的地区');return false;
        }
...
//		curTrans = $(this).parent().parent();
    ...
    $('.trans-line').on('click','.J_BatchDel',function(){
        if($(this).parent().parent().find('.tbl-except').find('input:checked').size()==0){
            Nc.alertError('请选择要批量处理的地区');return false;
        }

        Nc.layerConfirm("确认删除吗？",{},function(e){
...
//        });
    ...
    $('#dialog_batch').on('click','.J_SubmitPL',function(){
        ...
        $('.tbl-except>table>tbody>tr').each(function(){
            if ($(this).find('.J_BatchField').attr('checked')){
                ...
                var tmp = $(obj_this).find('input[data-field="start"]').val();
                if (tmp != ''){
                    if (freightGlobal.calcType == "number") {
                        tmp = toIntValue(tmp);
                    } else {
                        tmp = Nc.numberFormat(tmp,2);
                    }
                }else{
                    if (freightGlobal.calcType == "number") {
                        tmp = 1;
                    } else {
                        tmp = Nc.numberFormat(1,2);
                    }
                }
                $(this).find('input[data-field="start"]').val(tmp).removeClass('input-error');

                tmp = $(obj_this).find('input[data-field="plus"]').val();
                if (tmp != ''){
                    if (freightGlobal.calcType == "number") {
                        tmp = toIntValue(tmp);
                    } else {
                ...
                $(this).find('input[data-field="plus"]').val(tmp).removeClass('input-error');

                var oNum = new Number($(obj_this).find('input[data-field="postage"]').val());
                oNum = oNum.toFixed(2);
                if (oNum > 999.99) oNum = 999.99;
                if (oNum=='NaN') oNum = '0.00';
                $(this).find('input[data-field="postage"]').val(oNum).removeClass('input-error');
                var oNum = new Number($(obj_this).find('input[data-field="postageplus"]').val());
                oNum = oNum.toFixed(2);
                if (oNum > 999.99) oNum = 999.99;
                if (oNum=='NaN') oNum = '0.00';
                $(this).find('input[data-field="postageplus"]').val(oNum).removeClass('input-error');
            }
        });
        $("#dialog_batch").css('display','none');
        $('.ks-ext-mask').css('display','none');
    ...
    $('#submit_tpl').on('click',function(){
        if($('.tbl-except').find('.cell-area').size() == 0) {
            Nc.alertError("请指定地区城市");
            return false;
        }
        ...
        father = $('.entity');
        if (freightGlobal.isFreightFree == false) {
            //首费JS空判断-------------------------------
        ...
        if (isSubmit == true){
            $("#freightForm").on("nc.ajaxSubmit.success",function(e,result){
                Nc.alertSucceed(result.message,{end:function(){
                    window.location.href = ncGlobal.sellerRoot + "freight/template/list";
                }});
