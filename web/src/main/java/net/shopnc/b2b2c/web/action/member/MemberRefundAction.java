...
public class MemberRefundAction extends MemberBaseAction {
     ...
     * @return
     */
    @RequestMapping(value = "choose/{ordersId}/{orderGoodsId}", method = RequestMethod.GET)
    public String chooseRefund(@PathVariable int ordersId, @PathVariable int orderGoodsId, ModelMap modelMap) {
    ...
    public String list(@RequestParam(value = "page", required = false, defaultValue = "1") Integer page,
        ...
        return getMemberTemplate("refund/list");
    }
    ...
    public String info(@PathVariable(value = "refundId") int refundId, ModelMap modelMap) {
        ...
        return getMemberTemplate("refund/info");
    }
     ...
     * @return
     */
    @RequestMapping(value = "addall/{ordersId}", method = RequestMethod.GET)
    public String addAll(@PathVariable Integer ordersId, ModelMap modelMap) {
        ...
        //menuKey
        modelMap.put("menuKey", "refund");
        return getMemberTemplate("refund/add_all");
    }
     ...
     * @return
     */
    @RequestMapping(value = "addgoods/{ordersId}/{orderGoodsId}", method = RequestMethod.GET)
    public String addGoods(@PathVariable int ordersId, @PathVariable int orderGoodsId, ModelMap modelMap) {
        ...
        //menuKey
        modelMap.put("menuKey", "refund");
        return getMemberTemplate("refund/add_goods");
    }
}
