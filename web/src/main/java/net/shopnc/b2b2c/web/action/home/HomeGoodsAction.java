...
public class HomeGoodsAction extends HomeBaseAction {
    ...
    public String info(@PathVariable int goodsId, ModelMap modelMap) throws ShopException {
            ...
            // 商品活动详细信息
            List<GoodsActivity> goodsActivity = goodsActivityService.findGoodsActivityById(goodsDetail.getCommonId());
            if( goodsActivity.size() > 0){//如果该商品有活动正在进行中
            	return "redirect:/activity/activityInfo?goodsId="+goodsId;
            }
