...
public class MemberInvoiceJsonAction extends MemberBaseJsonAction {
     ...
     */
    @ResponseBody
    @RequestMapping(value = "invoice/list/json")
    ...
    public ResultEntity del(@RequestParam(value = "invoiceId", required = true) Integer invoiceId) {
        ResultEntity resultEntity = new ResultEntity();
        try {
            invoiceDao.delInvoice(invoiceId,SessionEntity.getMemberId());
            resultEntity.setCode(ResultEntity.SUCCESS);
