...
public class MemberBaseAction {
    ...
    protected static final String MEMBER_TEMPLATE_ROOT = "member/";
    ...
    public LinkedHashMap<String, Object> getMenuList() {
        ...
        menuItemListProperty.put("card", new HashMap<String,String>(){{put("name", "我的卡券");put("url", ShopConfig.getMemberRoot()+"card/index");}});
