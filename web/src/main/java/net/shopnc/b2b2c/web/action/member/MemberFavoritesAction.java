...
public class MemberFavoritesAction extends MemberBaseAction {
     ...
     * @return
     */
    @RequestMapping(value = "favorites/goods", method = RequestMethod.GET)
    public String index(@RequestParam(value = "page", required = false, defaultValue="1") Integer page,
        ...
        return getMemberTemplate("favorites/goods_pic");
    }
    /**
     * 商品关注列表
     * @param page
     ...
     * @return
     */
    @RequestMapping(value = "favorites/goods/list", method = RequestMethod.GET)
    ...
    public String storeList(@RequestParam(value = "page", required = false, defaultValue="1") Integer page,
                            ModelMap modelMap) {
        //查询列表
        HashMap<String,Object> params = new HashMap<String, Object>();
        params.put("memberId", SessionEntity.getMemberId());
        ...
        return getMemberTemplate("favorites/store_list");
    }
    /**
     * 店铺新品
     * @param storeId
