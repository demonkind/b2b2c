...
public class MemberReturnAction extends MemberBaseAction {
    ...
    public String list(@RequestParam(value = "page", required = false, defaultValue = "1") Integer page,
        ...
        return getMemberTemplate("return/list");
    }
    /**
     * 退货详情
     * @param refundId
    ...
    public String info(@PathVariable(value = "refundId") int refundId, ModelMap modelMap) {
        ...
        //menuKey
        modelMap.put("menuKey", "refund");
        return getMemberTemplate("return/info");
    }
     ...
     * @return
     */
    @RequestMapping(value = "add/{ordersId}/{orderGoodsId}", method = RequestMethod.GET)
    public String addReturn(@PathVariable int ordersId, @PathVariable int orderGoodsId, ModelMap modelMap) {
        ...
        //menuKey
        modelMap.put("menuKey", "refund");
        return getMemberTemplate("return/add");
    }
     ...
     * @return
     */
    @RequestMapping(value = "ship/{refundId}", method = RequestMethod.GET)
    public String ship(@PathVariable int refundId, ModelMap modelMap) {
