package net.shopnc.b2b2c.api.alipay.common.util;
...
import net.shopnc.b2b2c.api.alipay.common.sign.MD5;
...
public class AlipayNotify {
    ...
    public AlipayNotify(HashMap<String, String> paymentInfo){
	...
	private boolean getSignVeryfy(Map<String, String> Params, String sign) {
        ...
        if(AlipayConfig.sign_type.equals("MD5") ) {
        	isSign = MD5.verify(preSignStr, sign, this.paymentInfo.get("alipayKey"), AlipayConfig.input_charset);
        }
        return isSign;
    }
    ...
    */
    private String verifyResponse(String notify_id) {
        ...
        String partner = this.paymentInfo.get("alipayPartner");
